...
class Agent:
    ...
    def train_long_memory(self):
        if len(self.memory) > BATCH_SIZE:
            mini_sample = random.sample(self.memory, BATCH_SIZE)    # returns tuple list
        else:
    ...
    def get_action(self, state):
        #  random moves: tradeoff btn exploration and exploitation
